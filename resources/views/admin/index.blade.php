...
@section('content')
    ...
    <div class="flex min-h-screen flex-col bg-gray-100 md:flex-row">
        <!-- Sidebar -->
        <div class="w-full bg-white shadow-lg md:w-64">
            <div class="p-4">
                <h2 class="text-xl font-semibold text-gray-800 md:text-2xl"><i
                        class="fas fa-tachometer-alt me-2"></i>لوحة التحكم</h2>
            </div>
            <nav class="mt-4">
                ...
                <a href="{{ 'admin.authors.index' }}"
                    class="block px-4 py-2 text-gray-600 hover:bg-gray-100 hover:text-gray-800">
                    <i class="fas fa-users me-2"></i>المؤلفون
                </a>
