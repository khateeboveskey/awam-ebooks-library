...
@section('content')
    <div class="py-6 sm:py-12">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm dark:bg-primary-800 rounded-lg">

                <div class="p-4 sm:p-6">
                    <div class="mb-6 sm:mb-8">
                        <h2
                            class="text-2xl font-bold text-primary-900 dark:text-primary-100 sm:text-3xl">
                            {{ $author->name }}
                        </h2>
                        @if ($author->bio)
                            <p
